...
var MouseWheelZoom_1 = __importDefault(require("ol/interaction/MouseWheelZoom"));
var RBase_1 = __importDefault(require("./RBase"));
var RMouseWheelZoom = (function (_super) {
    __extends(RMouseWheelZoom, _super);
    function RMouseWheelZoom() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RMouseWheelZoom.prototype.createOL = function (props) {
        var _this = this;
        this.classProps = RMouseWheelZoom.classProps;
        return new MouseWheelZoom_1.default(Object.keys(props)
    ...
    return RMouseWheelZoom;
}(RBase_1.default));
exports.default = RMouseWheelZoom;
